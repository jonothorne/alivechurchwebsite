...
<section class="page-hero <?= $hero_texture_class; ?>">
    <div class="container narrow">
        <p class="eyebrow" data-cms-editable="hero_eyebrow" data-cms-page="gdpr" data-cms-type="text"><?= $cms->text('hero_eyebrow', 'Legal'); ?></p>
        <h1 data-cms-editable="hero_title" data-cms-page="gdpr" data-cms-type="text"><?= $cms->text('hero_title', 'Your Data Rights'); ?></h1>
        <p data-cms-editable="hero_subtitle" data-cms-page="gdpr" data-cms-type="text"><?= $cms->text('hero_subtitle', 'Understanding your rights under the General Data Protection Regulation (GDPR).'); ?></p>
    </div>
</section>

<section class="legal-content">
    <div class="container narrow" data-cms-editable="content" data-cms-page="gdpr" data-cms-type="html">
