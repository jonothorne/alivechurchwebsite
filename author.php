...
// Parse social links and build proper URLs
$socialLinksRaw = $author['social_links'] ? json_decode($author['social_links'], true) : [];
$socialLinks = [];
...
if (!empty($socialLinksRaw['twitter'])) {
    ...
    $socialLinks['twitter'] = (strpos($val, 'http') === 0) ? $val : 'https://twitter.com/' . $val;
}
...
if (!empty($socialLinksRaw['youtube'])) {
    $val = $socialLinksRaw['youtube'];
    $socialLinks['youtube'] = (strpos($val, 'http') === 0) ? $val : 'https://youtube.com/' . $val;
}
if (!empty($socialLinksRaw['website'])) {
    $val = $socialLinksRaw['website'];
    $socialLinks['website'] = (strpos($val, 'http') === 0) ? $val : 'https://' . $val;
}
            ...
            <?php if (!empty($socialLinks)): ?>
                <div class="author-social">
                    ...
                    <?php if (!empty($socialLinks['twitter'])): ?>
                        <a href="<?= htmlspecialchars($socialLinks['twitter']); ?>" target="_blank" rel="noopener" class="social-btn" title="Twitter/X">
                            <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                        </a>
                    <?php endif; ?>
                    <?php if (!empty($socialLinks['facebook'])): ?>
                        <a href="<?= htmlspecialchars($socialLinks['facebook']); ?>" target="_blank" rel="noopener" class="social-btn" title="Facebook">
                            <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                        </a>
                    <?php endif; ?>
                    <?php if (!empty($socialLinks['instagram'])): ?>
                        <a href="<?= htmlspecialchars($socialLinks['instagram']); ?>" target="_blank" rel="noopener" class="social-btn" title="Instagram">
                    ...
                    <?php if (!empty($socialLinks['linkedin'])): ?>
                        <a href="<?= htmlspecialchars($socialLinks['linkedin']); ?>" target="_blank" rel="noopener" class="social-btn" title="LinkedIn">
                    ...
                    <?php if (!empty($socialLinks['youtube'])): ?>
                        <a href="<?= htmlspecialchars($socialLinks['youtube']); ?>" target="_blank" rel="noopener" class="social-btn" title="YouTube">
