...
.realtime-feed-item-new {
    ...
    border-left: 3px solid var(--app-analytics-color);
    padding-left: 1rem;
    margin-left: -1rem;
    margin-right: 0;
}
.realtime-feed-item-new:hover {
...
.realtime-feed-item-new .realtime-feed-icon {
    background: var(--app-analytics-color);
    color: #fff;
}
...
.realtime-feed-item-new .realtime-feed-time {
    background: var(--app-analytics-color);
    color: #fff;
}
</style>
...
<!-- Auto-refresh script -->
<script <?= csp_nonce(); ?>>
// Refresh real-time data every 10 seconds
