    ...
    <div class="analytics-col">
        <div class="admin-card" style="margin-bottom: 1.5rem;">
            <div class="admin-card-header">
                ...
                <a href="/adminnew/analytics/404s?period=<?= $period; ?>" class="seo-view-all">View all</a>
            </div>
            <?php
    ...
    <div class="analytics-col">
        <div class="admin-card" style="margin-bottom: 1.5rem;">
            <div class="admin-card-header">
                ...
                <a href="/adminnew/analytics/referrers?period=<?= $period; ?>" class="seo-view-all">View all</a>
            </div>
    ...
    <div class="analytics-col">
        <div class="admin-card" style="margin-bottom: 1.5rem;">
            <div class="admin-card-header">
                ...
                <a href="/adminnew/analytics/gsc?period=<?= $period; ?>" class="seo-view-all">View all</a>
            </div>
...
<div class="admin-card" style="margin-top: 1.5rem;">
    ...
    <div class="seo-nav-grid">
        <a href="/adminnew/analytics/landing-pages?period=<?= $period; ?>" class="seo-nav-item">
        ...
        <a href="/adminnew/analytics/404s?period=<?= $period; ?>" class="seo-nav-item">
            <div class="seo-nav-icon">
        ...
        <a href="/adminnew/analytics/trends?period=<?= $period; ?>" class="seo-nav-item">
            <div class="seo-nav-icon">
        ...
        <a href="/adminnew/analytics/referrers?period=<?= $period; ?>" class="seo-nav-item">
            <div class="seo-nav-icon">
        ...
        <a href="/adminnew/analytics/googlebot?period=<?= $period; ?>" class="seo-nav-item">
            <div class="seo-nav-icon">
        ...
        <a href="/adminnew/analytics/gsc?period=<?= $period; ?>" class="seo-nav-item <?= !$gscConnected ? 'seo-nav-item-disabled' : ''; ?>">
            <div class="seo-nav-icon">
