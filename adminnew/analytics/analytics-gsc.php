        ...
        <div style="padding: 1.5rem;">
            ...
            <ol class="gsc-setup-steps">
                ...
                <li>Add the following as an <strong>Authorized redirect URI</strong>:<br>
                    <code class="gsc-code">https://<?= htmlspecialchars($_SERVER['HTTP_HOST']); ?>/adminnew/analytics/gsc</code>
                </li>
            ...
            <form method="POST" style="margin-top: 1.5rem;">
                ...
                <div class="gsc-form-group">
                    ...
                    <input type="text" id="redirect_uri" name="redirect_uri" class="admin-input" value="<?= htmlspecialchars($config['redirect_uri'] ?? 'https://' . $_SERVER['HTTP_HOST'] . '/adminnew/analytics/gsc'); ?>">
                </div>
