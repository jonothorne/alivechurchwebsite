    ...
    <div class="admin-card">
        <div class="admin-card-header">
            <div class="admin-filter-tabs" style="margin: 0; flex-wrap: wrap;">
                <a href="/adminnew/profanity-filter" class="admin-filter-tab <?= !$categoryFilter ? 'active' : ''; ?>">All</a>
                <?php foreach ($categories as $value => $label): ?>
                    <a href="/adminnew/profanity-filter?category=<?= $value; ?>" class="admin-filter-tab <?= $categoryFilter === $value ? 'active' : ''; ?>">
                        <?= $label; ?>
                    </a>
                <?php endforeach; ?>
            </div>
