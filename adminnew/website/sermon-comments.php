...
<div style="margin-bottom: 1.5rem;">
    <a href="/adminnew/sermons" style="color: #667eea; text-decoration: none;">&larr; Back to Sermons</a>
</div>
...
<div class="card">
    ...
    <div class="filter-tabs" style="margin-bottom: 1.5rem;">
        <a href="/adminnew/sermons/comments?status=pending" class="filter-tab <?= $statusFilter === 'pending' ? 'active' : ''; ?>">
            Pending (<?= $counts['pending']; ?>)
        </a>
        <a href="/adminnew/sermons/comments?status=approved" class="filter-tab <?= $statusFilter === 'approved' ? 'active' : ''; ?>">
            Approved (<?= $counts['approved']; ?>)
        </a>
        <a href="/adminnew/sermons/comments?status=spam" class="filter-tab <?= $statusFilter === 'spam' ? 'active' : ''; ?>">
            Spam (<?= $counts['spam']; ?>)
        </a>
    </div>
