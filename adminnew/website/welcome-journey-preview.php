...
<div class="admin-card">
    <div class="admin-card-header">
        <h3>Email Preview</h3>
        <a href="/adminnew/welcome-journeys" class="btn btn-xs btn-outline">Back to Journeys</a>
    </div>
    ...
    <div style="margin-bottom: 1.5rem; display: flex; gap: 1rem; flex-wrap: wrap; align-items: center;">
        ...
        <button id="updatePreviewBtn" class="btn btn-primary btn-sm">Update Preview</button>
    </div>

    <!-- Device Toggle -->
    <div style="margin-bottom: 1rem; display: flex; gap: 0.5rem;">
        <button class="btn btn-sm device-btn active" data-device="desktop">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>
            Desktop
        </button>
        <button class="btn btn-sm btn-outline device-btn" data-device="mobile">
