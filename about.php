...
$page_description = 'Learn about Alive Church Norwich - our story, values, and vision. A Christ-centred, Spirit-led community in the heart of Norwich since the 1980s.';
...
<section id="beliefs" class="content-section">
    <div class="container split">
        <div>
            ...
            <?= $cms->image('whoweare_image', '/assets/imgs/gallery/alive-church-worship-congregation.jpg', 'Alive Church worship service', ['class' => 'content-image']); ?>
        </div>
        <div class="card">
    ...
    <div class="container">
        ...
        <div class="card-grid profile-grid">
            <article class="profile-card">
                <?= $cms->image('leader1_image', '/assets/imgs/gallery/alive-church-congregation-hands-raised.jpg', 'Pastor speaking at Alive Church'); ?>
            ...
            <article class="profile-card">
                <?= $cms->image('leader2_image', '/assets/imgs/gallery/alive-church-worship-leaders-performance.jpg', 'Worship leaders at Alive Church'); ?>
            ...
            <article class="profile-card">
                <?= $cms->image('leader3_image', '/assets/imgs/gallery/alive-church-live-worship-band-lincolnshire.jpg', 'Youth worship at Alive Church'); ?>
            ...
            <article class="profile-card">
                <?= $cms->image('leader4_image', '/assets/imgs/gallery/alive-church-live-worship-band-lincolnshire.jpg', 'Youth worship at Alive Church'); ?>
