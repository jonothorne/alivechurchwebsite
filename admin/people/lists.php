    ...
    switch ($postAction) {
        case 'create':
            ...
            if ($listRepo->findBySlug($slug)) {
                ...
                header('Location: /admin/people?page=lists&action=view&id=' . $newId . '&created=1');
                exit;
            }
            break;
        ...
        case 'delete':
            if ($listRepo->deleteList($listId)) {
                header('Location: /admin/people?page=lists&deleted=1');
                exit;
            } else {
        ...
        <div class="lists-section">
            ...
            <div class="lists-row">
                <?php foreach ($systemLists as $l): ?>
                    <a href="/admin/people?page=lists&action=view&id=<?= $l['id']; ?>" class="list-card" style="--list-color: <?= htmlspecialchars($l['color']); ?>">
...
<div class="admin-actions-bar">
    <div class="actions-left">
        <a href="/admin/people?page=lists" class="btn btn-outline">&larr; All Lists</a>
    ...
    <?php else: ?>
        <table class="people-table">
            ...
            <tbody>
                <?php foreach ($members['items'] as $p): ?>
                    <tr>
                        <td>
                            <a href="/admin/people?page=view&id=<?= $p['id']; ?>">
        ...
        <?php if ($members['total_pages'] > 1): ?>
            <div class="pagination-wrapper">
                ...
                echo $pagination->render("/admin/people?page=lists&action=view&id={$listId}&p={page}");
                ?>
            </div>
        <?php endif; ?>
    <?php endif; ?>
