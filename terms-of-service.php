...
$cms = new ContentManager('terms-of-service');
...
<section class="page-hero <?= $hero_texture_class; ?>">
    <div class="container narrow">
        <p class="eyebrow" data-cms-editable="hero_eyebrow" data-cms-page="terms-of-service" data-cms-type="text"><?= $cms->text('hero_eyebrow', 'Legal'); ?></p>
        <h1 data-cms-editable="hero_title" data-cms-page="terms-of-service" data-cms-type="text"><?= $cms->text('hero_title', 'Terms of Service'); ?></h1>
        <p data-cms-editable="hero_subtitle" data-cms-page="terms-of-service" data-cms-type="text"><?= $cms->text('hero_subtitle', 'The terms and conditions governing your use of our website and services.'); ?></p>
    </div>
</section>

<section class="legal-content">
    <div class="container narrow" data-cms-editable="content" data-cms-page="terms-of-service" data-cms-type="html">
