...
$cms = new ContentManager('privacy-policy');

include __DIR__ . '/includes/header.php';

// Default content for the policy
$default_content = '
...
<section class="page-hero <?= $hero_texture_class; ?>">
    <div class="container narrow">
        <p class="eyebrow" data-cms-editable="hero_eyebrow" data-cms-page="privacy-policy" data-cms-type="text"><?= $cms->text('hero_eyebrow', 'Legal'); ?></p>
        <h1 data-cms-editable="hero_title" data-cms-page="privacy-policy" data-cms-type="text"><?= $cms->text('hero_title', 'Privacy Policy'); ?></h1>
        <p data-cms-editable="hero_subtitle" data-cms-page="privacy-policy" data-cms-type="text"><?= $cms->text('hero_subtitle', 'How we collect, use, and protect your personal information.'); ?></p>
    </div>
</section>

<section class="legal-content">
    <div class="container narrow" data-cms-editable="content" data-cms-page="privacy-policy" data-cms-type="html">
